...
18. Get Base Certificate Details for a Private Label
    [Tags]	Functional	certificate	PL  create	POST    current
    ${result}    run keyword and ignore error   Get Base Certificate Details for a Private Label   abcdef
    run keyword if  ${result} != ('FAIL', u'HTTPError: HTTP Error 400: Bad Request')    Fail	test1 Teardown
