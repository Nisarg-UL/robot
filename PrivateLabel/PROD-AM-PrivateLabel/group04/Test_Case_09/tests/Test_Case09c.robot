...
17. Search for the Private Label
    [Tags]	Functional	create  POST	current
    ${response}    search private label  certificateType=Regression%20Scheme&issuingBody=USA&mark=Listed&ownerReference=${Asset_Owner_Ref}&certificateName=Regression-US001-1
