...
13. Add Asset To Private Label
    ...
    ${pl_asset2}  Add Asset To Private Label  Private_Label/Add_Asset2_To_Private_Label_With_Same_Taxonomy_As_Asset1.json   ${PrivateLabel_Id}
    set global variable  ${PrivateLabel_Asset_Id2}   ${pl_asset2}
    should be equal  ${PrivateLabel_Asset_Id1}   ${PrivateLabel_Asset_Id2}
...
14. View Private Label Assets
    ...
    should be equal  ${Asset_Id}   ["${asset_Id_Product1}"]
#    should be equal  ${UL_Asset_Id}   ["${asset_Id_Product1}"]
