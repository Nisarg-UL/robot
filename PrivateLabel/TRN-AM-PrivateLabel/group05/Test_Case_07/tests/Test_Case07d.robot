...
18. Search for the Private Label Assets
    ...
    ${response}  Search Private label Asset    productType=Regression%20Test%20Product%201&referenceNumber=PL_DEMOFILE01&family_Series=Reg-Test&modelName=PL_Regression_Test_Model_1
