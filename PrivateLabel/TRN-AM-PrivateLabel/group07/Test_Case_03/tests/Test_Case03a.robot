...
19. View Private Label Asset
    ...
    ${response}  run keyword and ignore error  View Private Label Assets    ${PrivateLabel_Asset_Id}
    run keyword if  ${response} != (\'FAIL\', u"KeyError: \'plAssetId\'")	Fail	test1 Teardown
    log to console  ${response}
