...
19. Search for the Private Label
    ...
    ${response}    search private label  issuingBody=USA&mark=Listed&productType=Regression%20Test%20Product%201&ownerReference=${Asset_Owner_Ref}&certificateName=${Certificate_Name}
