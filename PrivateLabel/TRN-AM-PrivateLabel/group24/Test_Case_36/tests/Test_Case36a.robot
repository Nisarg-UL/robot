...
16. Edit Multiple Private Label Asset with Duplicate Taxonomy of different Base Asset & Existing Reference Number
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_Multiple_PL_Assets_DuplicateTaxonomy_OfDifferentBaseAsset_ExistingReferenceNumber_ChangeFlag_Y.json   ${PrivateLabel_Id}
...
#    should be equal  ${UL_Asset_Id}   ["${asset_Id_Product1}", "${asset_Id_Product1}"]
    ...
    should be equal  ${pl_asset_ref_no}   ["PL_DEMOFILE01", "PL_DEMOFILE01", "PL_DEMOFILE01", "PL_DEMOFILE01"]
