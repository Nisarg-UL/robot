...
30. Certify certificate1
    ...
    Add Decisions to Certificate  Certificate/Certify_RegressionCertificatewithWDpriortoTodaysdate_AfterModify.json  ${Certificate_Id}

31. Modify Private Label2
    [Tags]	Functional	certificate	PL  POST    current
...
32. Get Private Label details from Private Label2 Table
    [Tags]	Functional	certificate	PL  create	POST    current
...
33. Withdraw Private Label2 with with WD < System's date(now()) and ED = <empty>
    [Tags]	Functional	certificate	PL  POST    current
    Certify Private Label  Private_Label/Certify_PrivateLabelCertificate2_Withdraw_AfterModify.json

34. Validate Certificate Status
