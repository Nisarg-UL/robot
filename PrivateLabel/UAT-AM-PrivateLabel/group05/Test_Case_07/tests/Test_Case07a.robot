...
22. Search for the Private Label Assets
    ...
    ${response}  Search Private label Asset    productType=Regression%20Test%20Product%201&ownerReference_PartySiteID=${asset_owner_ref}&referenceNumber=PL_DEMOFILE01&family_Series=Reg-Test
