...
22. Search for the Private Label Assets
    ...
    ${response}  Search Private label Asset    ownerReference_PartySiteID=${asset_owner_ref}&referenceNumber=PL_DEMOFILE01&family_Series=Reg-Test&modelName=PL_Regression_Test_Model_1
