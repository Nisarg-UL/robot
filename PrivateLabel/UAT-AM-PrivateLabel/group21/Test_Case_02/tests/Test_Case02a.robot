...
40. Certificate Date Validation
    [Tags]	Functional	certificate	PL  create	POST    current
    Certificate Date Validation    Private_Label/Certificate_EDpriortoPLED&WDpriortoPLWD.json   certificateName=${Certificate_Name}&&certificateType=Regression%20Scheme&&ownerReference=${cert_owner_ref}
