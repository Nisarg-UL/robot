...
20. Get Private Label details from PL Revisions Table
    [Tags]	Functional	certificate	PL  create	POST    current
    Get Private Label Version from PL Revisions Table   ${Unique_PrivateLabel_Id}
    run keyword if  '${PrivateLabel_Ver_Revisions}' != '1.0, 1.0, 2.0'     Fail
