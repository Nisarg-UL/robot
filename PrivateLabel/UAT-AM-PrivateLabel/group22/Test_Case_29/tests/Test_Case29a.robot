...
26. Modify Private Label
    [Tags]	Functional	certificate	PL  POST    current
    Modify Private Lable    Private_Label/Modify_PrivateLabelCertificate_ChangingDateValueEmpty.json   ${PrivateLabel_Id}
...
27. Certify Private Label
	...
	run keyword if  "${msg}" != "Exception occurred while validating the privateLabel - Error while validating Test Date Value cannot be empty/null"  Fail	test1 Teardown
	log to console  ${msg}
