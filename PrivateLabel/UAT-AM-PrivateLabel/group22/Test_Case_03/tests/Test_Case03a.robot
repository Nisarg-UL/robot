...
19. Get Private Label details from Private Label Table
    ...
    Get Private Label Version from Private Label Table   ${pl_Id}
...
21. Get Private Label details from PL Asset Table
    [Tags]	Functional	certificate	PL  create	POST    current
    Get Unique PrivateLabelId from PL Asset Table   ${PrivateLabel_Asset_Id}
    run keyword if  '${Unique_PrivateLabel_Id}' != '${pl_Id_PLasset}'     Fail
