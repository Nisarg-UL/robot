...
#
#25. Certify certificate
#    [Tags]	Functional	certificate	create	POST    current
#    set global variable  ${Certificate_Id}   ${Certificate_Id_Modify}
#    Certify Certificate  Certificate/Certify_RegressionCertificatewithWDpriortoTodaysdate_AfterModify.json
#
#26. Validate Certificate Status
#    [Tags]	Functional	certificate	create	current
#    ${response}  Get certificate status
#    log to console  ${response}
...
27. Modify base Certificate
	[Tags]	Functional	certificate	create	POST    current
    Modify Certificate    Certificate/Modify_RegressionSchemeCertificate_Revision2.json   ${Certificate_Id}
    run keyword if  '${Certificate_Id}' == '${Certificate_Id_Modify}'     Fail

28. Certify certificate
    [Tags]	Functional	certificate	create	POST    current
    set global variable  ${Certificate_Id}   ${Certificate_Id_Modify}
    Certify Certificate  Certificate/Certify_RegressionCertificate_AfterModify2.json

29. Validate Certificate Status
    [Tags]	Functional	certificate	create	current
    ${response}  Get certificate status
    log to console  ${response}
    run keyword if	${response} != "Active"	Fail	test1 Teardown

30. Modify Private Label
    [Tags]	Functional	certificate	PL  POST    current
...
31. View Private Label Assets
    [Tags]	Functional	certificate	PL  POST    current
    ${response}  View Private Label Assets Details    ${PrivateLabel_Id_Modify}
    set global variable  ${PrivateLabel_Asset_Id_Modify}    ${response}
    run keyword if  '${PrivateLabel_Asset_Id_Modify}' == '${PrivateLabel_Asset_Id}'  Fail	test1 Teardown