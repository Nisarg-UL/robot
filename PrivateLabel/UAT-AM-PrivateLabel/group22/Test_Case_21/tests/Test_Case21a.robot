...
24. Modify Private Label by changing the certificate name
    [Tags]	Functional	certificate	PL  Edit    POST    current
    Modify Private Lable    Private_Label/Modify_PrivateLabelCertificate_changingCertificateName.json    ${PrivateLabel_Id}
