...
14. Edit Private Label Asset with Empty referenceNumber & referencenoChangeFlag - Y
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_EmptyReferenceNumber_ReferenceNoChangeFlag_Y.json   ${PrivateLabel_Id}
...
#    should be equal  ${UL_Asset_Id}   ["${asset_Id_Product1}", "${asset_Id_Product1}"]
    ...
    should be equal  ${pl_asset_ref_no}   ["${empty}", "${empty}"]
