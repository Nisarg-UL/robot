...
15. Edit Private Label Asset with New Model Nomenclature
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_Model_Nomenclature.json   ${PrivateLabel_Id}
...
16. View Private Label Assets
    ...
    should be equal  ${PL_Id}   ${PrivateLabel_Id}
    should be equal  ${PL_Asset_Id}   ${PrivateLabel_Asset_Id1}
    should be equal  ${pl_asset_model_nomenclature}  ${pl_modelNomenclature_edit}