...
14. Edit Private Label Asset with Empty AssetId
    [Tags]	Functional	certificate	PL  create	POST    current
    set global variable  ${asset_Id_Product1}   ABCDEFGH-IJKL-MNOP-QRSTUVWXYZ00
    run keyword and ignore error  Edit Private Label Asset taxonomy and model nomenclature  Empty_Data.json   ${PrivateLabel_Id}
