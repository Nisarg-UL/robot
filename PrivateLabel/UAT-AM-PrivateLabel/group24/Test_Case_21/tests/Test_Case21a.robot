...
14. Edit Private Label Asset with Duplicate Taxonomy & Existing Reference Number
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_DuplicateTaxonomy_ExistingReferenceNumber_ChangeFlag_N.json   ${PrivateLabel_Id}
    ...
    should be empty  ${pl_asset_edit_success}
