...
17. Search for the Private Label
    ...
    ${response}    search private label  certificateType=Regression%20Scheme&issuingBody=USA&mark=Listed&ownerReference=${Asset_Owner_Ref}&certificateName=${Certificate_Name}
