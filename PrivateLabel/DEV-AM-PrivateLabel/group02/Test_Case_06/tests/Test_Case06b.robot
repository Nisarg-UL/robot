...
13. Add Asset To Private Label
    [Tags]	Functional	certificate	PL  create	POST    current
    ${pl_asset1}    Add Asset To Private Label  Private_Label/Add_Asset_To_Private_Label_with_Empty_CreationDate.json   ${PrivateLabel_Id}
...
#    should be equal  ${UL_Asset_Id}   ["${asset_Id_Product1}"]
    ...
    should be equal  ${pl_asset_creation_date}  ["${today_date}"]
