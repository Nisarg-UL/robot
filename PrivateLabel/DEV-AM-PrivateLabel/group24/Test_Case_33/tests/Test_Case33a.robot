...
16. Edit Private Label Asset with Duplicate Taxonomy of different Base Asset & New Reference Number
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_DuplicateTaxonomy_OfDifferentBaseAsset_NewReferenceNumber_ChangeFlag_N.json   ${PrivateLabel_Id}
    ${success_models}   pl_asset_edit_values    ${pl_asset_edit_success}    ${modelName_key}
    should be equal  ${success_models}   ["PL_Regression_Test_Model_12"]
