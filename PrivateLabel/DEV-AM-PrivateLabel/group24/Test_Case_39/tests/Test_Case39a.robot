...
15. Edit Private Label Asset with Empty AssetId
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_Empty_assetId.json   ${PrivateLabel_Id}
    ...
    should be equal  ${error_assetId}   ["${empty}"]
