...
16. Edit Private Label Asset with Duplicate Taxonomy of different Base Asset & Existing Reference Number
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_DuplicateTaxonomy_OfDifferentBaseAsset_ExistingReferenceNumber_ChangeFlag_N.json   ${PrivateLabel_Id}
