...
14. Edit Private Label Asset with New Family_Series
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_Family_Series.json   ${PrivateLabel_Id}
