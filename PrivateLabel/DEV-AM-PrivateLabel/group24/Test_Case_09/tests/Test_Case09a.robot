...
15. Edit Private Label Asset with New Model Name
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_ModelName.json   ${PrivateLabel_Id}
    ...
    should be equal  ${success_models}   ["PL_Regression_Test_Model_1_Edit"]
...
#    should be equal  ${PL_Id}   ["${PrivateLabel_Id}", "${PrivateLabel_Id}"]
    ...
    should be equal  ${Asset_Id}   ["${asset_Id_Product1}", "${asset_Id_Product1}"]
#    should be equal  ${UL_Asset_Id}   ["${asset_Id_Product1}", "${asset_Id_Product1}"]
    should be equal  ${pl_asset_model_name}   ["PL_Regression_Test_Model_1_Edit", "PL_Regression_Test_Model_2"]
    should be equal  ${pl_asset_ref_no}   ["PL_DEMOFILE01", "PL_DEMOFILE01"]
