...
14. Edit Private Label Asset with Empty PLAssetId
    [Tags]	Functional	certificate	PL  create	POST    current
    set global variable  ${PrivateLabel_Asset_Id1}   ${empty}
    run keyword and ignore error  Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_NewReferenceNumber_ReferenceNoChangeFlag_Y.json   ${PrivateLabel_Id}
