...
16. Edit Private Label Asset with Duplicate Taxonomy of different Base Asset & New Reference Number
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_DuplicateTaxonomy_OfDifferentBaseAsset_NewReferenceNumber_ChangeFlag_Y.json   ${PrivateLabel_Id}
...
#    should be equal  ${UL_Asset_Id}   ["${asset_Id_Product1}", "${asset_Id_Product1}"]
    ...
    should be equal  ${pl_asset_ref_no}   ["PL_DEMOFILE01_Edit", "PL_DEMOFILE01_Edit", "PL_DEMOFILE01_Edit"]
