...
14. Edit Multiple Private Label Asset with Duplicate Taxonomy & Existing Reference Number
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_Multiple_PL_Assets_DuplicateTaxonomy_ExistingReferenceNumber_ChangeFlag_N.json   ${PrivateLabel_Id}
