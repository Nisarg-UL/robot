...
14. Edit Private Label Asset with Empty Taxonomy, Existing referenceNumber & referencenoChangeFlag - Y
    [Tags]	Functional	certificate	PL  create	POST    current
    Edit Private Label Asset taxonomy and model nomenclature  Edit_PL_Asset_EmptyTaxonomy_ExistingReferenceNumber_ReferenceNoChangeFlag_Y.json   ${PrivateLabel_Id}
