...
21. Certify Private Label with WD = <empty> and ED < System's date(now())
    [Tags]	Functional	certificate	PL  POST    current
    Certify Private Label  Private_Label/Certify_PrivateLabelCertificatewithWDempty&EDpriortoCD_withHardCodeED.json
