...
40. Certificate Date Validation
    [Tags]	Functional	certificate	PL  create	POST    current
    ${result}    run keyword and ignore error   Certificate Date Validation    Private_Label/Certificate_EDequaltoPLED&WDequaltoPLWD.json   certificateName=${Certificate_Name}&&certificateType=Regression%20Scheme&&ownerReference=${cert_owner_ref}
