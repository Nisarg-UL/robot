...
19. Search for the Private Label Assets
    [Tags]	Functional	create  POST	current
    ${response}  Search Private label Asset    productType=Regression%20Test%20Product%201&referenceNumber=PL_DEMOFILE01&modelName=PL_Regression_Test_Model_1
