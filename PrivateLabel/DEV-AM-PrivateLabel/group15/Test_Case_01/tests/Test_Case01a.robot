...
19. View Base Asset of a private label asset
    [Tags]	Functional	certificate	PL  create	POST    current
    ${result}  View Base Asset of a private label asset   ${PrivateLabel_Asset_Id}
    run keyword if  '${result}' != '${asset_Id_Product1}'     Fail   test1 Teardown
    log to console  Base Asset ID: ${result}