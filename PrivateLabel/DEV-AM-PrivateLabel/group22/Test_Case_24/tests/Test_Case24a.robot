...
24. Modify Private Label with wrong data type
    [Tags]	Functional	certificate	PL  Edit    POST    current
    ${response}     run keyword and ignore error    Modify Private Lable    Private_Label/Modify_PrivateLabelCertificate_withWrongDataType.json    ${PrivateLabel_Id}
