...
24. Certification Mark for Private Label
    [Tags]	Functional	certificate create	current
    ${Result}   Certificate Mark for Private Label   ${PrivateLabel_Id}
...
28. Certification Mark for Private Label
    [Tags]	Functional	certificate create	current
    ${Result}   Certificate Mark for Private Label   ${PrivateLabel_Id_Modify}
    log to console  ${Result}
    run keyword if  ${Result} != "Listed"      Fail    test1 Teardown

29. End Date CET_V2.1
	[Tags]	Functional	POST	current
