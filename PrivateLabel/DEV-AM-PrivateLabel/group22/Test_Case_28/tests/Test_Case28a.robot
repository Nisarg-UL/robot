...
26. Modify Private Label
    [Tags]	Functional	certificate	PL  POST    current
    Modify Private Lable    Private_Label/Modify_PrivateLabelCertificate_V2.json   ${PrivateLabel_Id}
    ...
    ${test_integer}   Get Test Integer Attribute Value from Private Label     ${PrivateLabel_Id_Modify}
    run keyword if  '${test_integer}' != '1'     Fail

27. End Date CET_V2.1
	[Tags]	Functional	POST	current
