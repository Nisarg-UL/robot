...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_20/inputrequest/CreateProduct20.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_20/inputrequest/ModifyProduct20.json    ${asset_Id_Product1}
    ${data_CtoT}     Get Asset Attribute Value   ${response_api.json()}  changedDataType9_CtoT
	run keyword if  '${data_CtoT}' != 'AxxRx ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vel egestas lacus, et fermentum libero. Cras finibus velit lectus, a euismod nullam'  Fail	test1 Teardown
