...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_14/inputrequest/CreateProduct14.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_14/inputrequest/ModifyProduct14.json    ${asset_Id_Product1}
    ${data_ItoT}     Get Asset Attribute Value   ${response_api.json()}  changedDataType5_ItoT
	run keyword if  '${data_ItoT}' != '5'  Fail	test1 Teardown
