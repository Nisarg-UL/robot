...
${data_misfit_testing_v1_hierarchy_Id}     9ab43e3c-ccdc-405a-a4d0-76126c991ed8  #for PROD
${data_misfit_testing_v2_hierarchy_Id}     cd51d4c8-84c8-42af-b504-e86c83ca2947  #for PROD
${misfit_v1_metadataId}         10124a5a-fa8d-40c1-be85-583a61aa67d0             #for PROD
${misfit_v2_metadataId}         c9468bf3-9a7e-4a7a-bd8e-db049bc7ae26             #for PROD
${data_misfit_testing_v3_hierarchy_Id}     4a78b300-4b93-4357-a020-7b82684f1d49  #for PROD
${data_misfit_testing_v4_hierarchy_Id}     fa73ebc5-6527-47dd-a8c7-6129b3e215e6  #for PROD
${misfit_v3_metadataId}         879b8c52-32a7-41be-abd7-3beb4ba82720             #for PROD
${misfit_v4_metadataId}         9fac22dd-36e2-4d53-bbe5-b13a1aa7b47d             #for PROD
...
Details of an Asset for Content Type
    [Arguments]	${assetId}
    ${response}=	urllib2.urlopen	${API_ENDPOINT}/assets/assetDetails/${assetId}?ContentType=true
    ${json_convert}	json load data	${response}
    ${result}	convert	${json_convert}
    [Return]	${result}
