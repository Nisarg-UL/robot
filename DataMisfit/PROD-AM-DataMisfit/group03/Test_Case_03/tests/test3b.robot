...
3. Asset Creation With POST Request
    ...
    create product1 asset	group03/Test_Case_03/inputrequest/CreateProduct1b.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group03/Test_Case_03/inputrequest/ModifyProduct1b.json    ${asset_Id_Product1}
