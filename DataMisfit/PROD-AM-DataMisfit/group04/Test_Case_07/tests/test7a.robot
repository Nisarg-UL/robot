...
12. Link Component to Product
    [Tags]	Functional	current
    ${result}   Link Components to Asset    group04/Test_Case_07/inputrequest/Link_Product1toComponent1.json     ${asset_Id_Product1}
...
20. View Asset Component Details
    ...
    ${card_change_freetxt1}     Get Asset Linkage Value with seq    ${response}  cardinalityChange4_FreeText   1
	...
	${card_change_freetxt2}     Get Asset Linkage Value with seq    ${response}  cardinalityChange4_FreeText   2
	...
	${card_change_freetxt3}     Get Asset Linkage Value with seq    ${response}  cardinalityChange4_FreeText   3
...
#    set test variable	${card_change_freetxt1}	${response[0]["hasAssetLinkage"][33]["value"]}
#	run keyword if  '${card_change_freetxt1}' != 'AxxRx ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vel egestas lacus, et fermentum libero. Cras finibus velit lectus, a euismod nullamq'  Fail	test1 Teardown
#    set test variable	${card_change_freetxt2}	${response[0]["hasAssetLinkage"][34]["value"]}
#	run keyword if  '${card_change_freetxt2}' != 'AxxRx ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vel egestas lacus, et fermentum libero.'  Fail	test1 Teardown
#    set test variable	${card_change_freetxt3}	${response[0]["hasAssetLinkage"][35]["value"]}
#	run keyword if  '${card_change_freetxt3}' != 'AxxRx ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vel egestas lacus, et fermentum libero.'  Fail	test1 Teardown
