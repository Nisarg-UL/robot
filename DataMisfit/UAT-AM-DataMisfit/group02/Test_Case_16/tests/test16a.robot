...
12. Link Component to Product
    [Tags]	Functional	current
    ${result}   Link Components to Asset    group02/Test_Case_16/inputrequest/Link_Product1toComponent1.json     ${asset_Id_Product1}
...
20. View Asset Component Details
    ...
    ${data_datetoT}     Get Asset Linkage Value   ${response}  changedDataType7_DatetoT
	run keyword if  '${data_datetoT}' != '2018-05-17'  Fail	test1 Teardown
