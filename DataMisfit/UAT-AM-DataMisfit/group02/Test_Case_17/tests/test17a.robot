...
12. Link Component to Product
    [Tags]	Functional	current
    ${result}   Link Components to Asset    group02/Test_Case_17/inputrequest/Link_Product1toComponent1.json     ${asset_Id_Product1}
...
20. View Asset Component Details
    ...
    ${data_LOVtoScale}     Get Asset Linkage Value   ${response}  changedDataType10_LOVtoScale
