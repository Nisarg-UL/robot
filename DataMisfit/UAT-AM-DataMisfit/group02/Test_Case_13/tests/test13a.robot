...
12. Link Component to Product
    [Tags]	Functional	current
    ${result}   Link Components to Asset    group02/Test_Case_13/inputrequest/Link_Product1toComponent1a.json     ${asset_Id_Product1}
...
20. View Asset Component Details
    ...
    ${data_TtoI}     Get Asset Linkage Value   ${response}  changedDataType5a_TtoI
