...
12. Link Component to Product
    [Tags]	Functional	current
    ${result}   Link Components to Asset    group02/Test_Case_19/inputrequest/Link_Product1toComponent1a.json     ${asset_Id_Product1}
...
#	run keyword if  '${data_group_removal1}' != '1'  Fail	test1 Teardown
#	set test variable	${data_group_removal2}	${response[0]["hasAssetLinkage"][23]["value"]}
#	run keyword if  '${data_group_removal2}' != '1.5'  Fail	test1 Teardown
#	set test variable	${data_group_removal3}	${response[0]["hasAssetLinkage"][24]["value"]}
#	run keyword if  '${data_group_removal3}' != 'Yes'  Fail	test1 Teardown
#	set test variable	${data_group_removal4}	${response[0]["hasAssetLinkage"][25]["value"]}
#	run keyword if  '${data_group_removal4}' != 'Up'  Fail	test1 Teardown
