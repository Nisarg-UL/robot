...
12. Link Component to Product
    [Tags]	Functional	current
    ${result}   Link Components to Asset    group02/Test_Case_23/inputrequest/Link_Product1toComponent1b.json     ${asset_Id_Product1}
...
20. View Asset Component Details
    ...
    ${card_change_dec1}     Get Asset Linkage Value   ${response}  cardinalityChange2_Decimal
