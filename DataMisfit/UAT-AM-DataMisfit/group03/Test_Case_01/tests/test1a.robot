...
13. Modify Product1
	...
	run keyword if  '${msg}' != 'Exception occurred while validating the product - Asset Data Validation -> Error while validating Text Attribute 7 - Scale Scale Red; Green; Blue; Orange'  Fail	test1 Teardown
	log to console  ${msg}