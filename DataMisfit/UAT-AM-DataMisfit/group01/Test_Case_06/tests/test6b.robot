...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_06/inputrequest/CreateProduct6b.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_06/inputrequest/ModifyProduct6b.json    ${asset_Id_Product1}
    ${int_att1}     Get Asset Attribute Value   ${response_api.json()}  integerAttribute1
	run keyword if  '${int_att1}' != '8'  Fail	test1 Teardown
