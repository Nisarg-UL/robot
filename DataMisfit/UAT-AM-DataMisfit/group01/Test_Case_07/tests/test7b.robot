...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_07/inputrequest/CreateProduct7b.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_07/inputrequest/ModifyProduct7b.json    ${asset_Id_Product1}
    ${int_att2}     Get Asset Attribute Value   ${response_api.json()}  integerAttribute2
	run keyword if  '${int_att2}' != '10'  Fail	test1 Teardown
