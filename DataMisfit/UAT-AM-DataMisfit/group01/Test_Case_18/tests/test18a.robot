...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_18/inputrequest/CreateProduct18.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_18/inputrequest/ModifyProduct18.json    ${asset_Id_Product1}
    ${data_datetoT}     Get Asset Attribute Value   ${response_api.json()}  changedDataType7_DatetoT
	run keyword if  '${data_datetoT}' != '2018-05-16'  Fail	test1 Teardown
