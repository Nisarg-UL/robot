...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_03/inputrequest/CreateProduct3.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_03/inputrequest/ModifyProduct3.json    ${asset_Id_Product1}
    ${txt_att3_LOV}     Get Asset Attribute Value   ${response_api.json()}  textAttribute3_LOV
    should be empty     ${txt_att3_LOV}
