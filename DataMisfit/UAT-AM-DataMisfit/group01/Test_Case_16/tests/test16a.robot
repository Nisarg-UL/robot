...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_16/inputrequest/CreateProduct16.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_16/inputrequest/ModifyProduct16.json    ${asset_Id_Product1}
    ${data_DtoT}     Get Asset Attribute Value   ${response_api.json()}  changedDataType6_DectoT
	run keyword if  '${data_DtoT}' != '5.3'  Fail	test1 Teardown
