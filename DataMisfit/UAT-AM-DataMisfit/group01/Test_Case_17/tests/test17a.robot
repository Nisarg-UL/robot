...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_17/inputrequest/CreateProduct17a.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_17/inputrequest/ModifyProduct17a.json    ${asset_Id_Product1}
    ${data_TtoDec}     Get Asset Attribute Value   ${response_api.json()}  changedDataType6a_TtoDec
	run keyword if  '${data_TtoDec}' != '5.3'  Fail	test1 Teardown
