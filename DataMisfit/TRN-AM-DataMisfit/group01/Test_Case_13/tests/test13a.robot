...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_13/inputrequest/CreateProduct13.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_13/inputrequest/ModifyProduct13.json    ${asset_Id_Product1}
    ${data_BtoT}     Get Asset Attribute Value   ${response_api.json()}  changedDataType4_BtoT
	run keyword if  '${data_BtoT}' != 'Yes'  Fail	test1 Teardown
