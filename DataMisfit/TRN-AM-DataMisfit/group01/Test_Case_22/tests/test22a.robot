...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_22/inputrequest/CreateProduct22.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_22/inputrequest/ModifyProduct22.json    ${asset_Id_Product1}
    ${data_LOVtoScale}     Get Asset Attribute Value   ${response_api.json()}  changedDataType10_LOVtoScale
	run keyword if  '${data_LOVtoScale}' != 'Low'  Fail	test1 Teardown
