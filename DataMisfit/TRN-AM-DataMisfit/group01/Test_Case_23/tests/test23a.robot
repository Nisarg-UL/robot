...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_23/inputrequest/CreateProduct23.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_23/inputrequest/ModifyProduct23.json    ${asset_Id_Product1}
    ${data_ScaletoLOV}     Get Asset Attribute Value   ${response_api.json()}  changedDataType11_ScaletoLOV
	run keyword if  '${data_ScaletoLOV}' != 'Slow'  Fail	test1 Teardown
