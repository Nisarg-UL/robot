...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_02/inputrequest/CreateProduct2.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_02/inputrequest/ModifyProduct2.json    ${asset_Id_Product1}
    ${txt_att2_LOV}     Get Asset Attribute Value   ${response_api.json()}  textAttribute2_LOV
    should be empty     ${txt_att2_LOV}
