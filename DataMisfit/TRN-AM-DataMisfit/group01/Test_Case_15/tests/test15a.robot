...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_15/inputrequest/CreateProduct15a.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_15/inputrequest/ModifyProduct15a.json    ${asset_Id_Product1}
    ${data_TtoI}     Get Asset Attribute Value   ${response_api.json()}  changedDataType5a_TtoI
	run keyword if  '${data_TtoI}' != '5'  Fail	test1 Teardown
