...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_11/inputrequest/CreateProduct11.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    Modify Product1 Asset   group01/Test_Case_11/inputrequest/ModifyProduct11.json    ${asset_Id_Product1}
    ${data_TtoB}     Get Asset Attribute Value   ${response_api.json()}  changedDataType3_TtoB
	run keyword if  '${data_TtoB}' != 'Yes'  Fail	test1 Teardown
