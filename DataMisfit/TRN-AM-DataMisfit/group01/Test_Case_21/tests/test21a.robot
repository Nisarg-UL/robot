...
3. Asset Creation With POST Request
    ...
    create product1 asset	group01/Test_Case_21/inputrequest/CreateProduct21.json
...
13. Modify Product1
	[Tags]	Functional	POST	current
    ${response}  run keyword and ignore error    Modify Product1 Asset   group01/Test_Case_21/inputrequest/ModifyProduct21.json    ${asset_Id_Product1}
    ${msg}  Get Error Message   ${response_api}
	run keyword if  '${msg}' != 'Unable to perform update due to SQL Exception'  Fail	test1 Teardown
	log to console  ${msg}
