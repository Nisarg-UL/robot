...
20. View Asset Component Details
	...
	${data_grp_att13}     Get Asset Linkage Value with seq    ${response}  dataGroupAttribute5   3
	run keyword if  '${data_grp_att13}' != '3'  Fail	test1 Teardown
	${data_grp_att23}     Get Asset Linkage Value with seq    ${response}  dataGroupAttribute6   3
	run keyword if  '${data_grp_att23}' != '0.3'  Fail	test1 Teardown
	${data_grp_att33}     Get Asset Linkage Value with seq    ${response}  dataGroupAttribute7   3
	run keyword if  '${data_grp_att33}' != ''  Fail	test1 Teardown
	${data_grp_att43}     Get Asset Linkage Value with seq    ${response}  dataGroupAttribute8   3
