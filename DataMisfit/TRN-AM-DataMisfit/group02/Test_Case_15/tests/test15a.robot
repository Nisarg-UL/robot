...
12. Link Component to Product
    [Tags]	Functional	current
    ${result}   Link Components to Asset    group02/Test_Case_15/inputrequest/Link_Product1toComponent1a.json     ${asset_Id_Product1}
...
20. View Asset Component Details
    ...
    ${data_TtoDec}     Get Asset Linkage Value   ${response}  changedDataType6a_TtoDec
