...
12. Link Component to Product
    [Tags]	Functional	current
    ${result}   Link Components to Asset    group02/Test_Case_19/inputrequest/Link_Product1toComponent1b.json     ${asset_Id_Product1}
...
20. View Asset Component Details
    ...
    ${data_group_removal1}     Get Asset Linkage Value with seq    ${response}  dataGroupRemoval1   1
	run keyword if  '${data_group_removal1}' != '1'  Fail	test1 Teardown
	${data_group_removal2}     Get Asset Linkage Value with seq    ${response}  dataGroupRemoval2   1
	run keyword if  '${data_group_removal2}' != '1.1'  Fail	test1 Teardown
	${data_group_removal3}     Get Asset Linkage Value with seq    ${response}  dataGroupRemoval3   1
	run keyword if  '${data_group_removal3}' != 'Yes'  Fail	test1 Teardown
	${data_group_removal4}     Get Asset Linkage Value with seq    ${response}  dataGroupRemoval4   1
	run keyword if  '${data_group_removal4}' != 'Top'  Fail	test1 Teardown
	${data_group_removal12}     Get Asset Linkage Value with seq    ${response}  dataGroupRemoval1   2
	run keyword if  '${data_group_removal12}' != '2'  Fail	test1 Teardown
	${data_group_removal22}     Get Asset Linkage Value with seq    ${response}  dataGroupRemoval2   2
	run keyword if  '${data_group_removal22}' != '2.1'  Fail	test1  Teardown
	${data_group_removal32}     Get Asset Linkage Value with seq    ${response}  dataGroupRemoval3   2
	run keyword if  '${data_group_removal32}' != 'No'  Fail	test1 Teardown
	${data_group_removal13}     Get Asset Linkage Value with seq    ${response}  dataGroupRemoval1   3
	run keyword if  '${data_group_removal13}' != '3'  Fail	test1 Teardown
	${data_group_removal23}     Get Asset Linkage Value with seq    ${response}  dataGroupRemoval2   3
	run keyword if  '${data_group_removal23}' != '3.1'  Fail	test1 Teardown

#    set test variable	${data_group_removal1}	${response[0]["hasAssetLinkage"][22]["value"]}
#	run keyword if  '${data_group_removal1}' != '1'  Fail	test1 Teardown
#	set test variable	${data_group_removal12}	${response[0]["hasAssetLinkage"][23]["value"]}
#	run keyword if  '${data_group_removal12}' != '2'  Fail	test1 Teardown
#	set test variable	${data_group_removal13}	${response[0]["hasAssetLinkage"][24]["value"]}
#	run keyword if  '${data_group_removal13}' != '3'  Fail	test1 Teardown
#	set test variable	${data_group_removal2}	${response[0]["hasAssetLinkage"][25]["value"]}
#	run keyword if  '${data_group_removal2}' != '1.1'  Fail	test1 Teardown
#	set test variable	${data_group_removal21}	${response[0]["hasAssetLinkage"][26]["value"]}
#	run keyword if  '${data_group_removal21}' != '2.1'  Fail	test1 Teardown
#	set test variable	${data_group_removal22}	${response[0]["hasAssetLinkage"][27]["value"]}
#	run keyword if  '${data_group_removal22}' != '3.1'  Fail	test1 Teardown
#	set test variable	${data_group_removal3}	${response[0]["hasAssetLinkage"][28]["value"]}
#	run keyword if  '${data_group_removal3}' != 'Yes'  Fail	test1 Teardown
#	set test variable	${data_group_removal31}	${response[0]["hasAssetLinkage"][29]["value"]}
#	run keyword if  '${data_group_removal31}' != 'No'  Fail	test1 Teardown
#	set test variable	${data_group_removal4}	${response[0]["hasAssetLinkage"][30]["value"]}
#	run keyword if  '${data_group_removal4}' != 'Top'  Fail	test1 Teardown
