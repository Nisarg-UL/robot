...
12. Link Component to Product
    [Tags]	Functional	current
    ${result}   Link Components to Asset    group02/Test_Case_06/inputrequest/Link_Product1toComponent1b.json     ${asset_Id_Product1}
...
20. View Asset Component Details
    ...
    ${int_att1}     Get Asset Linkage Value   ${response}  integerAttribute1
