...
2. Role Access Configuration With POST Request
	[Tags]	Functional	POST    current
    run keyword and ignore error     Configure Role Access    Product/ConfigureRole_Owner_sameAttrPublic_forProduct1.json   Asset
...
4. Disfigure Role With POST Request
	[Tags]	Functional	POST    current
    Disfigure Role Access    Product/DisfigureRole_Owner_sameAttrPublic_forProduct1.json   Asset
