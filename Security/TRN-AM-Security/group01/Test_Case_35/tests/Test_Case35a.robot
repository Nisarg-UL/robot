...
1. Role Access Configuration With POST Request
    ...
    run keyword and ignore error   Configure Role Access    Certificate/ConfigureRole_InvalidRole_forRegressionScheme.json   Certificate
    ${error_msg}  Get Error Message  ${response_api}
    should be equal  ${error_msg}   Invalid Role name
