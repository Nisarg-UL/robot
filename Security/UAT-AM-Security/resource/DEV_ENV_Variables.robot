*** Variables ***
${API_ENDPOINT}	http://10.40.76.76:8080/InformationPlatformServices/api/v${Api_ver}	#For DEV

@{database}  pymysql    infopltfrm_transDBv07  ul_transUser    29LPMW6Ljv  usnbkq223d.global.ul.com    3306	#DB for DEV
