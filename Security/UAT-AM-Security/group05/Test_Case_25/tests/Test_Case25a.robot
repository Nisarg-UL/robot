...
14. View Private Label details using UserId & Role
	[Tags]	Functional	certificate create	POST    current
	View Private Label details using UserId & Role     ${PrivateLabel_Id}   ${EMPTY}   abcde
    ${attr_name}	get_attribute_names  ${cert_attr}   name
    compare lists  ${attr_name}    ['Certificate Type', 'Issuing Body', 'Mark', 'Certificate Name', 'Revision Number']
