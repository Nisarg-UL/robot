...
7. Get Certificate details using UserId & Role
	[Tags]	Functional	certificate create	POST    current
	Get Certificate details using UserId & Role     ${Certificate_Id}   ${EMPTY}   Public;Owner;Brand%20Owner;Production%20Site;Local%20Representative;Applicant
...
#    ${compare}   compare list of items  ${attr_name}  ${list}
