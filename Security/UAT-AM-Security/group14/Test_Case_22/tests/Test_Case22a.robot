...
12. Get Questions from Certificate
	[Tags]	Functional	certificate create	POST    current
    ${has_questions}   Get Questions from Certificate using UserId & Role    ${Certificate_Id}    ${EMPTY}    Local%20Representative
    Should not be Empty     ${has_questions}
    ${questions}	get_questions  ${cert_questions}
    run keyword if  ${questions} != ['Question1', 'Question2', 'Question3', 'Question4']     Fail
