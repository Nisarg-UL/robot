...
1a. Setting up Environment
	...
	set global variable  ${user}    ${EMPTY}
...
2. Get Role Access at Attribute Level
	[Tags]	Functional	POST    current
    ${att_role}    Get Role Access at Attribute Level   Certificate     Regression%20Scheme     Party%20Type     ${EMPTY}
    compare lists  ${att_role}   ['Public']
