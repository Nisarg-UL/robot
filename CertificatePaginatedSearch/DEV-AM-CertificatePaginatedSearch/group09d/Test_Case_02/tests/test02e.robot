...
6. Certificates creation
    ...
    set test variable  ${issuing_body_1}   ${issuing_body_2}
...
11. Search Certificate with multiple issuingBodyList values
	...
	set global variable  ${list_value1}   ${issuing_body_1}
	set global variable  ${list_value2}   ${issuing_body_2}
...
11a. Validate Certificate Details
	...
	compare lists  [${CS_certificate_type}, ${CS_certificate_name}, ${CS_Cerificate_owner_reference}, ${CS_issuing_body}, ${CS_mark}, ${CS_cert_ccn}]    [["${certificate_type_1}", "${certificate_type_1}"], ["${cert_name2}", "${certificate_name}"], ["${Cert_Owner_Ref}", "${Cert_Owner_Ref}"], ["${issuing_body_2}", "${issuing_body_1}"], ["${mark_1}", "${mark_1}"], ["${Scope_Code_1}", "${Scope_Code_1}"]]
...
11b. Validate findKeys Lists Details
    ...
    compare lists  ${FK_issuingBody_values}  ["${issuing_body_1}", "${issuing_body_2}"]