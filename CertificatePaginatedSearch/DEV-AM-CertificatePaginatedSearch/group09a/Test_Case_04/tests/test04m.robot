...
11a. Validate Certificate Details
	...
	Compare lists  [${certificate_status}, ${certificate_version}, ${revision_number}, ${certify}]   [["${status_Active}", "${EMPTY}"], ["${value_as_1.0}", "${value_as_1.0}"], ["${value_as_0}", "${value_as_0}"], ["${value_as_Y}", "${value_as_Y}"]]
	...
	compare lists  [${CS_issueDate}, ${CS_revisionDate}, ${CS_withdrawalDate}, ${CS_expiryDate}]     [["${today_date} ${time_00}", "${today_date} ${time_00}"], ["${future_date_1} ${time_00}", "${future_date_1} ${time_00}"], ["${future_date_2} ${time_00}", "${future_date_2} ${time_00}"], ["${future_date_3} ${time_00}", "${tomorrow_date} ${time_00}"]]
