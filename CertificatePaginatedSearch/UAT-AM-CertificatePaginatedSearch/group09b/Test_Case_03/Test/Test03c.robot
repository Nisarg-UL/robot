...
12. Search Certificate with 'fromWithdrawalDate' as past date & 'toWithdrawalDate' as current date
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${fromWithdrawalDate_value}  ${past_date_2}
...
12a. Validate Certificate Details
    ...
    should be equal  ${is_privateLabel}  []
