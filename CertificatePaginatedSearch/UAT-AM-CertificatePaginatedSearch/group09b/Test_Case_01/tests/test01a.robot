...
12. Search Certificate with fromIssueDate & toIssueDate as current date
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${fromIssueDate_value}   ${today_date}
	set global variable  ${toIssueDate_value}    ${today_date}
