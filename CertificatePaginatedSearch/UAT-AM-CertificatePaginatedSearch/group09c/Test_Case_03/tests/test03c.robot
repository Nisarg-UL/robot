...
11. Search Certificate with searchParameters as issuingBody
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${operator_value}   ${exact_search_value}
	set global variable  ${search_parameter}  ${issuingBody_key}
	set global variable  ${search_parameter_value}   ${issuing_body_1}
