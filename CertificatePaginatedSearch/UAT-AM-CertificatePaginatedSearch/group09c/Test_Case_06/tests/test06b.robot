...
11. Search Certificate with searchParameters as productType
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${operator_value}   ${exact_search_value}
	set global variable  ${search_parameter}  ${productType_key}
	set global variable  ${search_parameter_value}   ${product_type_1}
