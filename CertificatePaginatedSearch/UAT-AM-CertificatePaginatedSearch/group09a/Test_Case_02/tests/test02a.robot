...
11. Search Certificate with searchText
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${searchText_value}    ${certificate_name_1}
	Paginated Search for Certificate    Certificate_Search_with_searchText.json
...
11b. Validate findKeys searchText Details
    ...
    should be equal  ${FK_searchText}  ${certificate_name_1}