...
10. Search Certificate with multiple partySiteNumberList values
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${list_name}   ${partySiteNumberList_key}
	set global variable  ${list_key}   ${partySiteNumber_key}
	set global variable  ${list_value1}   ${BO_partysite_number_1}
	set global variable  ${list_value2}   ${PS_partysite_number_1}
...
10b. Validate findKeys Lists Details
    ...
    compare lists  ${FK_partySiteNumber_values}  ["${BO_partysite_number_1}", "${PS_partysite_number_1}"]