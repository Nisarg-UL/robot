...
10. Search Certificate with partySiteNumberList
	...
	set global variable  ${list_value}   ${PS_partysite_number_1}
...
10b. Validate findKeys Lists Details
    ...
    compare lists  ${FK_partySiteNumber_values}  ["${PS_partysite_number_1}"]