...
5. Serach Collection with Collection Name and ProjectNumber and Order Number and Quote Number and Owner ref and Project type
    [Tags]	Functional	current
    ${response}  Search Collection   collectionName=Collection1&projectNumber=${Collection_Project_no}&orderNumber=${Collection_Order_no}&quoteNumber=${Collection_Quote_no}&ownerReference_PartySiteID=${Asset_Owner_Ref}_${Today_Date}_less_than_100_charat&productType=Regression%20Test%20Product%201
