...
8. Render Verdict
	...
	${response3}	Render Verdict	group/Test_Case_06/inputrequest/request3.json	${asset_Id_Product1}
...
#Customer requests to change Product Type (ver1.0) for Immutable Asset
#-Product Type -  (future date)
10. Change Creation Date
    [Tags]	Functional	POST	current
    run keyword and ignore error  Modify Taxonomy Bulk_Model Without Collection_Id   change_product_Bulk_Model.json
