...
17. View Private Label Certify Details using Role
	[Tags]	Functional	certificate create	POST    current
    View Private Label Certify using Parameters    ${PrivateLabel_Id}    role=Public
    ${attr_names}	privatelabel_certify  ${pl_certify}    name
    should be equal    "${attr_names}"    "['Certification Comment', 'Certifier Employee Name', 'Certifier Employee Number']"
    ${attr_display_names}	privatelabel_certify  ${pl_certify}    displayName
    should be equal   "${attr_display_names}"    "['Certification Comment', 'Certifier Employee Name', 'Certifier Employee Number']"
