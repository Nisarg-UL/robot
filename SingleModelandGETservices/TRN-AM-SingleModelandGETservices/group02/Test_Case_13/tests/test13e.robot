...
17. View Private Label Recommendations Details using UserId & Role
	[Tags]	Functional	certificate create	POST    current
    View Private Label Recommendations using Parameters    ${PrivateLabel_Id}    user=81349&role=Public
    ${attr_names}	privatelabel_recommendations  ${pl_recommendations}    name
    should be equal    "${attr_names}"    "['Recommendation Status', 'Recommendation Comment', 'Reviewer Employee Name', 'Reviewer Employee Number', 'Review Date']"
    ${attr_display_names}	privatelabel_recommendations  ${pl_recommendations}    displayName
    should be equal   "${attr_display_names}"    "['Recommendation Status', 'Recommendation Comment', 'Reviewer Employee Name', 'Reviewer Employee Number', 'Date of Review']"
