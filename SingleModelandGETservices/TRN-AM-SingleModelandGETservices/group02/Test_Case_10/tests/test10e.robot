...
17. Get Projects and Decisions from Private Label using UserID & Role
	[Tags]	Functional	certificate create	POST    current
    ${has_certify}   Get Projects and Decisions from Private Label    ${PrivateLabel_Id}    user=81349&role=Public
