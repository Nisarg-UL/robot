...
17. View Private Label Questions Details using UserID & Role
	[Tags]	Functional	certificate create	POST    current
    View Private Label Questions using Parameters    ${PrivateLabel_Id}    user=81349&role=Public
    ${attr_names}	privatelabel_questions  ${pl_questions}    name
    should be equal    "${attr_names}"    "['Question1', 'Question2', 'Question3', 'Question4', 'Question5', 'Question6', 'Question7', 'Question8', 'Question9']"
    ${attr_display_names}	privatelabel_questions  ${pl_questions}    displayName
    should be equal   "${attr_display_names}"    "['File Number - Verify Availability', 'Project Number or Service Request', 'e-mail address for receiving electronic certificates - Verify availability. Unless specially indicated. Contact information in the ePro profile is considered as the eCert attention', 'Applicant: Name and Address: Required Information: Verify availability', 'Applicant: Subscriber number exists', 'Manufacturer: Name and Address: Required Information: Verify availability', 'Factory: Name and Address: Required Information: Verify availability', 'Factory: Declaration per 6 2 5 provided (if more then one factory)', 'Factory: Subscriber number exists']"
