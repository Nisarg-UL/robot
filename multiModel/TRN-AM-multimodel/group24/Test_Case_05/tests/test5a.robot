...
5. Asset2 Creation with POST Request
    ...
    create Asset2 based on product1 Asset1   CreationOfRegressionProduct1Asset2_siscase1_withemptymandatoryassetattributes.json
...
15. Validate and Update Compliance Collection Level
	...
	${msg}  Get Validation Error for Update Compliance Collection Level   ${response_api}    ${asset_Id_Product12}
