...
11. Complete Evaluation
    ...
    ${response}  run keyword and ignore error  Complete Evaluation with CollectionID   markcollectioncomplete.json	${asset_Id_Product1}    abcd
    ${msg}  Get Error Message   ${response_api}
	run keyword if  '${msg}' != 'Invalid collectionId'  Fail	test1 Teardown
	log to console  ${msg}
