...
4. Serach Collection with Collection Name and ProjectNumber and Order Number and Quote Number
    [Tags]	Functional	current
    ${response}  run keyword and ignore error  Search Collection With Exact Search as False   collectionName=Collection100&projectNumber=${Collection_Project_no}&orderNumber=${Collection_Order_no}&quoteNumber=${Collection_Quote_no}
