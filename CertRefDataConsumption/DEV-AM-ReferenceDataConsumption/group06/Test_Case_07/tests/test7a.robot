...
13. Get certificate Details
    ...
    length should be  ${cert_ref_attr}   1

14. Modify certificate
    [Tags]	Functional	certificate create	POST    current
    Modify Certificate    Certificate/Modify_RegressionSchemeCertificate_removeReferenceAttribute_standard.json   ${Certificate_Id}
    run keyword if  '${Certificate_Id}' == '${Certificate_Id_Modify}'     Fail

14. Certify certificate
    [Tags]	Functional	certificate	create	POST    current
    Add Decisions to Certificate  Certificate/Certify_RegressionCertificate_Revision1.json  ${Certificate_Id_Modify}
...
17. Modify Certificate
	[Tags]	Functional	certificate	create	POST    current
    Modify Certificate for Version3    Certificate/Modify_RegressionSchemeCertificate_removeReferenceAttribute_standard_revision2.json   ${Certificate_Id_Modify}
    run keyword if  '${Certificate_Id_Modify}' == '${Certificate_Id_Modify2}'     Fail

18. Validate Certificate Reference Attributes
    [Tags]	Functional	certificate    current
    Validate Certificate Reference Attributes   ${Certificate_Id_Modify2}
    should be empty  ${ref_attr_errors}

19. Get certificate Details
    [Tags]	Functional	certificate    current
    Get certificate Details using Mode     ${Certificate_Id_Modify2}    edit
    should not be empty  ${cert_ref_attr}
    length should be  ${cert_ref_attr}   1

20. Disfigure Role With POST Request
	[Tags]	Functional	POST    current
