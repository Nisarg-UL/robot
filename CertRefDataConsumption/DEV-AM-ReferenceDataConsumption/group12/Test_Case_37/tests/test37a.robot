...
18. Validate Certificate Reference Attributes
    ...
    ${error_msg}    cert_ref_attributes_errors_msg  ${ref_attr_errors}   Regression Scheme SC1
    run keyword if  '${error_msg}' != 'Selected value is no longer valid. Select a valid value'     Fail
...
20. Get Reference Attributes Details from ref_attributes Table
    [Tags]	Functional	certificate  current
