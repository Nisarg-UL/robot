...
13. Add associated attributes to scheme-scope-productType
    [Tags]	Functional	Test	POST    current  ReferenceData
    Add associated attributes to scheme-scope-productType    Add_Associated_Attributes_New.json  ${RegProd1_schemeScopeProductTypeId}

14. Get Associated Attributes of a Product
    [Tags]	Functional	Test	POST    current  ReferenceData
    Get Associated Attributes of a Product   ${Certificate_Id}   ${asset_Id_Product1}
    should not be empty  ${associated_attributes}
    compare lists  ${associated_attributes_names}  ['TP1 Attribute2', 'TP1 Attribute1', 'TP1 Attribute3']
