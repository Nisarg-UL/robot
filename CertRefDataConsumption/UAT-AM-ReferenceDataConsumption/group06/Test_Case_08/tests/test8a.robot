...
14. Modify certificate
    [Tags]	Functional	certificate create	POST    current
    Modify Certificate    Certificate/Modify_RegressionSchemeCertificate_addReferenceAttribute_standard.json   ${Certificate_Id}
...
17. Modify Certificate
	[Tags]	Functional	certificate	create	POST    current
    Modify Certificate for Version3    Certificate/Modify_RegressionSchemeCertificate_addReferenceAttribute_standard_revision2.json   ${Certificate_Id_Modify}
