...
20. Get Private Label Details
    [Tags]	Functional	certificate    current
    View Private Label Details without using Mode     ${PrivateLabel_Id}
    should not be empty  ${pl_ref_attr}
    length should be  ${pl_ref_attr}   2

21. Modify Private Label
    [Tags]	Functional	certificate	PL  POST    current
    Modify Private Lable    Private_Label/Modify_PrivateLabelCertificate_removeReferenceAttribute_standard.json   ${PrivateLabel_Id}
    run keyword if  '${PrivateLabel_Id}' == '${PrivateLabel_Id_Modify}'     Fail

22. Validate Certificate Reference Attributes
    [Tags]	Functional	certificate    current
    Validate Certificate Reference Attributes   ${PrivateLabel_Id_Modify}
    should be empty  ${ref_attr_errors}

23. Get Private Label Details
    [Tags]	Functional	certificate    current
    View Private Label Details without using Mode     ${PrivateLabel_Id_Modify}
    should not be empty  ${pl_ref_attr}
    length should be  ${pl_ref_attr}   1

24. Certify Private Label
    [Tags]	Functional	certificate	PL  POST    current
    Certify Private Label  Private_Label/Certify_PrivateLabelCertificate_Version2.json

25. Modify Private Label
    [Tags]	Functional	certificate	PL  POST    current
    Modify Private Lable for Version3    Private_Label/Modify_PrivateLabelCertificate_removeReferenceAttribute_standard_revision2.json   ${PrivateLabel_Id_Modify}
    run keyword if  '${PrivateLabel_Id_Modify}' == '${PrivateLabel_Id_Modify2}'     Fail

26. Validate Certificate Reference Attributes
    [Tags]	Functional	certificate    current
    Validate Certificate Reference Attributes   ${PrivateLabel_Id_Modify2}
    should be empty  ${ref_attr_errors}

27. Get Private Label Details
    [Tags]	Functional	certificate    current
    View Private Label Details without using Mode     ${PrivateLabel_Id_Modify2}
    should not be empty  ${pl_ref_attr}
    length should be  ${pl_ref_attr}   1

28. Disfigure Role With POST Request
	[Tags]	Functional	POST    current
