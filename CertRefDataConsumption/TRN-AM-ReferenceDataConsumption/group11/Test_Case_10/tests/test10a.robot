...
21. Modify Private Label
    [Tags]	Functional	certificate	PL  POST    current
    Modify Private Lable    Private_Label/Modify_PrivateLabelCertificate_referenceAttributes_standard.json   ${PrivateLabel_Id}
...
22. Validate Certificate Reference Attributes
    ...
    ${error_msg}    cert_ref_attributes_errors_msg  ${ref_attr_errors}   Regression Scheme SL2
...
24. Disfigure Role With POST Request
	[Tags]	Functional	POST    current
