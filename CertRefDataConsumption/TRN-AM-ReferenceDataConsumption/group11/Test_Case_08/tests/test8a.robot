...
21. Modify Private Label
    [Tags]	Functional	certificate	PL  POST    current
    Modify Private Lable    Private_Label/Modify_PrivateLabelCertificate_addReferenceAttribute_standard.json   ${PrivateLabel_Id}
...
25. Modify Private Label
    [Tags]	Functional	certificate	PL  POST    current
    Modify Private Lable for Version3    Private_Label/Modify_PrivateLabelCertificate_addReferenceAttribute_standard_revision2.json   ${PrivateLabel_Id_Modify}
