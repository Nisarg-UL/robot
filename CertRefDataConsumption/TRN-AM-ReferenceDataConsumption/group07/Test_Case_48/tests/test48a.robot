...
8. Certificate Creation
	...
	set test variable  ${Regression_schemeScopeId}   ${Regression2_schemeScopeId}
	set test variable  ${RegVal_schemeScopeStandardId}   ${Reg2Val_schemeScopeStandardId}
...
13. Get Reference Attributes Details from ref_attributes Table
    ...
    run keyword if  '${pk1}' != '${scope2_Id}, ${Validation_standard_Id}'     Fail
    ${pk2}   Get Primary Keys from ref_attributes Table   ${Certificate_Id}  2
    run keyword if  '${pk2}' != '${Regression2_schemeScopeId}, ${Validation_standardLabel2_Id}'     Fail
    ${pk3}   Get Primary Keys from ref_attributes Table   ${Certificate_Id}  3
    run keyword if  '${pk3}' != '${Reg2Val_schemeScopeStandardId}'     Fail
