...
*** Variables ***
${API_ENDPOINT}	http://10.40.76.75:8080/InformationPlatformServices/api/v${Api_ver}	#For DEV

@{database}  pymysql    infopltfrm_transDBv07  ul_transUser    helloworld  usnbkq223d.global.ul.com    3306	#DB for DEV
...
${certificate_hierarchy_Id}     fbc30d47-b31a-4f75-9d83-d89b6499f236           #for DEV
${certificate2_hierarchy_Id}     d989144b-d996-4f85-b1cd-22865b26d8f7          #for DEV
#${certificate3_hierarchy_Id}                                                  #for DEV
${certificate_metadataId}       771d8028-8881-47af-8e07-f4163cab495e           #for DEV
${certificate2_metadataId}       73481cbf-40f5-4fbb-9f50-28d509c4e0e9          #for DEV
#${certificate3_metadataId}                                                    #for DEV
${standard_hierarchy_Id}	a20c6ef4-82bf-4395-b46c-76a5fb800799               #for DEV - with clause group
${standard_hierarchy_Id}	14f8ddd8-afa2-48f4-8234-88698628c44c               #for DEV - no clause group
${Reg_prod1_metadataId} 	ce2f293f-1f9a-4bb1-93d5-dcacb9b15ad1               #for DEV
${Reg_prod2_metadataId} 	dc155664-253a-471b-a300-d319d7545d9e               #for DEV
${Reg_prod3_metadataId} 	eef58fd3-952a-4fb8-afe6-c70751733564               #for DEV
${noEvalReqd_hierarchy_Id}     ge28b891-a43e-4f59-9f15-2554f93359fe            #for DEV
${regression_product_1_hierarchy_id}    d46a5d8d-a45d-4f28-b1f9-dace0ca53205   #for DEV
${regression_product_2_hierarchy_id}    dc155664-253a-471b-a300-d319d7545d9e   #for DEV
${regression_product_3_hierarchy_id}    e3379dce-3ec2-4893-9ae8-24942db6a513   #for DEV
...
Get AssesmentID
    ...
    log to console	"Assessment_Id": ${assessmentId}eeeeeeeeeeeeeeee
    [Return]	${result}
