...
*** Variables ***
${API_ENDPOINT}	http://10.40.76.78:8080/InformationPlatformServices/api/v${Api_ver}	#For TRN

@{database}  pymysql    infopltfrm_transDBv05   ul_transUser    PLnk2AQw6j  10.40.76.82    3306	#DB for TRN
...
${standard_hierarchy_Id}          dc90115f-7845-4429-b313-31eec9902357         #for TRN - no clause group
${Reg_prod1_metadataId}           1b836185-4818-4421-bb33-c9d2d9755f5c         #for TRN
${Reg_prod2_metadataId}           40ea3e1e-3f5e-41e1-a507-08fa09d0aa88         #for TRN
${Reg_prod3_metadataId}           65413277-e985-46be-852c-2d4f2d5ec46d         #for TRN
${noEvalReqd_hierarchy_Id}     1f7dc0d1-1f6d-439f-8e16-45b80aa6fdf9            #for TRN
${regression_product_1_hierarchy_id}    84d4d93f-7beb-4640-ab09-3098eb4b8640   #for TRN
${regression_product_2_hierarchy_id}    e59dce48-ab86-4b11-b092-d2cf6cbacd58   #for TRN
${regression_product_3_hierarchy_id}    ccb6fc3b-55c8-4b2b-b9bd-185b9e1ee73f   #for TRN
...
Get Collection_ID
    [Arguments]	${assetId}
    ${response}=	urllib2.urlopen	${API_ENDPOINT}/assets/${assetId}?user=81349
    ${json_convert}	json load data	${response}
    ${json}	convert	${json_convert}
    ${result}	col_id	${json}
...
#with Older certficate API (Non-Modularized one)
    ${response}=	urllib2.urlopen	${API_ENDPOINT}/assets/certificateDetails?certificateId=${Certificate_Id}&user=81349
    ${json_convert}	json load data	${response}
    ${json}	convert	${json_convert}
...
Get Test Integer Attribute Value
    [Arguments]	${cert_Id}
    ${response}=	urllib2.urlopen	${API_ENDPOINT}/assets/certificate/${cert_Id}?user=81349
    ${json_convert}	json load data	${response}
    ${json}	convert	${json_convert}
...
Get Test Integer Attribute Value from Private Label
    [Arguments]	${pl_Id}
    ${response}=	urllib2.urlopen	${API_ENDPOINT}/privateLabels/${pl_Id}?user=81349
    ${json_convert}	json load data	${response}
    ${json}	convert	${json_convert}
    ${result}	test_integer	${json}
    clear cache
