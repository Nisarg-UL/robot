...
7. Search Asset with all search parameters & family_Series Refiner
	...
	Search Asset    Asset_Search_with_all_searchParameters_oneRefiner.json
...
7c. Validate findKeys Details
    ...
    compare lists  ${SP_collectionName_values}   ["${collection_1}", "${like_search_value}"]
