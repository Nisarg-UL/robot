...
2. Search Asset with valid values
	...
	set global variable  ${fromCreatedDate_value}  ${yesterday_date}
	set global variable  ${toCreatedDate_value}   ${tomorrow_date}
	Search Asset    Asset_Search_with_fromCreatedDate&toCreatedDate.json
...
2b. Validate findKeys Details
    ...
    should be equal  ${FK_from&toCreatedDate}  [${yesterday_date}, ${tomorrow_date}]
