...
2. Search Asset with valid referenceNumber values
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${operator_value}  ${EMPTY}
	set global variable  ${reference_number_1}    ${reference_number}
	Search Asset    Asset_Search_with_referenceNumber.json
