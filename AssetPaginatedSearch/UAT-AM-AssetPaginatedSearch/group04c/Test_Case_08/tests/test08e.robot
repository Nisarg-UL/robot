...
8. Search Asset with valid quoteNumber
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${searchParameter_key}  ${quoteNumber_key}
	set global variable  ${operator_value}  ${like_search_value}
	set global variable  ${searchParameter_value}   ${Asset1_Collection_Quote_no}
