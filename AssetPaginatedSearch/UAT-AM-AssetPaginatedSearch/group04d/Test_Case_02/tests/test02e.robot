...
7. Search Asset with multiple ownerReferenceList values
...
7a. Validate Asset Details
	...
	compare lists   ${Asset_status}  ["${status_Active}", "${status_Active}"]
	...
	compare lists  ${Asset_updated_by}   ["${user_1}", "${user_1}"]
