...
7. Search Draft&Active Asset with valid statusList value
	[Tags]	Functional	asset   Search	POST    current
	Search Asset    Asset_Search_with_statusList_multiple.json
...
7b. Validate findKeys Details
	...
	compare lists  ${FK_status_values}   ["${status_Active}", "${status_Draft}"]