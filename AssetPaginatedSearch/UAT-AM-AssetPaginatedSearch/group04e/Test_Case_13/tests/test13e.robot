...
7. Search Asset with productType & all Refiners
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${searchParameter_key}  ${productType_key}
	set global variable  ${operator_value}  ${exact_search_value}
	set global variable  ${searchParameter_value}   ${product_type_1}
