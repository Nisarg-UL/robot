...
7. Search Asset with ownerReference & all Refiners
	...
	Search Asset    Asset_Search_with_searchParameter_allRefiners.json
...
7b. Validate Refiner Details
	...
	compare lists  ${RF_referenceNumber_list}    ['${reference_number_1}', ${value_as_1}, '${reference_number_2}', ${value_as_1}]
