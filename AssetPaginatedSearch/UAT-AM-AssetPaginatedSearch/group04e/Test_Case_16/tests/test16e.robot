...
7. Search Asset with family_Series & all Refiners
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${searchParameter_key}  ${family_Series_key}
	set global variable  ${operator_value}  ${exact_search_value}
	set global variable  ${searchParameter_value}   ${family_series_1}-${current_time}
...
7b. Validate Refiner Details
	...
	should not be empty  ${RF_family_series_list}
