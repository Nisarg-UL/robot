...
2. Search Asset with valid values
	...
	set global variable  ${fromModifiedDate_value}  ${yesterday_date}
	set global variable  ${toModifiedDate_value}   ${today_date}
...
2b. Validate findKeys Details
    ...
    should be equal  ${FK_from&toModifiedDate}  [${yesterday_date}, ${today_date}]
