...
7. Search Asset with Search Text
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${searchText_value}    ${family_series_1}-${current_time}
...
7b. Validate findKeys Details
    ...
    should be equal  ${FK_searchText}   ${family_series_1}-${current_time}
