...
7. Search Asset with referenceNumber & all Refiners
	[Tags]	Functional	asset   Search	POST    current
	set global variable  ${searchParameter_key}  ${referenceNumber_key}
	set global variable  ${operator_value}  ${exact_search_value}
	set global variable  ${searchParameter_value}   ${reference_number_1}
