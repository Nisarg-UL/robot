...
2. Search Asset with with invalid 'orderBy' value
	...
	set global variable  ${orderBy_value}    ${ownerReference_key}
	set global variable  ${completed_value}  ${value_as_N}
	set global variable  ${accepted_value}   ${value_as_N}
	run keyword and ignore error  Search Asset     Asset_Search_with_searchText_otherValues.json
