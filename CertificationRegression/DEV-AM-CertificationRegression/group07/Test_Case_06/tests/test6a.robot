...
13. Edit certificate using Wrong DataType
    [Tags]	Functional	certificate create	POST    current
    ${response}     run keyword and ignore error    Edit certificate  Certificate/EditOfRegressionSchemeCertificate_withWrongDataType.json    ${Certificate_Id}
