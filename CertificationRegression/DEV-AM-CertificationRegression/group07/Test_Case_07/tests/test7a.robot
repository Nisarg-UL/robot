...
13. Edit certificate by changing the certificate name
    [Tags]	Functional	certificate create	POST    current
    Edit certificate  Certificate/EditOfRegressionSchemeCertificate_changeCertificateName.json    ${Certificate_Id}
