...
14. Associate parties to certificate
    [Tags]	Functional	certificate POST    current
    associate parties to certificate    Certificate/Associate_New_Parties_Certificate.json

15. Unlink parties to certificate
    [Tags]	Functional	certificate POST    current
    associate parties to certificate    Certificate/Unlink_Parties_Certificate.json