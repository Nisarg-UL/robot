...
21. Associate parties to certificate
    [Tags]	Functional	certificate	create	POST    current
...
22. Certify certificate with Decisioning
    [Tags]	Functional	certificate	create	POST    current
...
26. Get Certificate details from Certificate Table
	[Tags]	Functional	certificate create	POST    current
