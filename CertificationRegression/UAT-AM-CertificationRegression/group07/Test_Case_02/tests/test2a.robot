...
18. Get Linked Assets from Modified Certificate
	[Tags]	Functional	certificate create	POST    current
    ${has_assets}   Get Linked Assets from Certificate    ${Certificate_Id_Modify}
    Should not be Empty     ${has_assets}

19. Get Decisions from Modified Certificate
	[Tags]	Functional	certificate create	POST    current
    ${has_certify}   Get Decisions from Certificate    ${Certificate_Id_Modify}
    Should be Empty     ${has_certify}

20. Get Certificate details from certificate table
	[Tags]	Functional	certificate create	POST    current
...
21. Get Certificate Transaction Id from Modified Certificate
	[Tags]	Functional	certificate create	POST    current
    Get Certificate Transaction Id after Modifying Certificate   ${Certificate_Id_Modify}
    run keyword if  '${Cert_Transaction_Id}' == '${Cert_Transaction_Id_Modify}'     Fail
