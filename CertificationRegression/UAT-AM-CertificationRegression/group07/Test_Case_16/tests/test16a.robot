...
19. Modify Certificate
	[Tags]	Functional	certificate create	POST    current
    Modify Certificate    Certificate/Modify_RegressionSchemeCertificate_V2.1.json   ${Certificate_Id}
    ${test_integer}   Get Test Integer Attribute Value     ${Certificate_Id_Modify}
    run keyword if  '${test_integer}' != '1'     Fail

20. End Date CET_V2.1
	[Tags]	Functional	POST	current
