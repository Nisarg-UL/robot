...
13. Lock Certificate with missing Certificate Parameters
    [Tags]	Functional	current
    ${response}  run keyword and ignore error  Lock Certificate  Lock_Template.json    certificateType=Regression%20Scheme&certificateName=Regression-US001-1
