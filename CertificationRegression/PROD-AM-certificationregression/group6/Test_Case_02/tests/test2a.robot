...
13. View Certificate with Certificate Params
    [Tags]	Functional	current
    ${response}  View Certificate  certificateType=Regression%20Scheme&ownerReference=${Cert_Owner_Ref}&certificateName=Regression-US001-1
	run keyword if  '${response}' != '${Certificate_Id}'  Fail	test1 Teardown