...
14. Select As Scheme from Regression to Regression2 scheme with Products only
   	[Tags]	Functional	certificate	create	POST    current
    Get HasAssets   Regression%20Scheme   Regression-US001-1
    Get HasEvaluations  Regression%20Scheme   Regression-US001-1
    Select As Cert Scheme    Certificate/SelectAsSchemeRegeression-Regression2SchemeCertwithproductsonly.json