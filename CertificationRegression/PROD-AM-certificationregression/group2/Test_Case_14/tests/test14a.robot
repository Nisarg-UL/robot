...
13. Select As Scheme from Regression to Regression2 scheme
   	[Tags]	Functional	certificate	create	POST    notcurrent
    Select As Cert Scheme    Certificate/SelectAsSchemeRegeression-Regression2SchemeCertwithcertificatename.json