...
23. Requirement Assignment To Product
	...
	Save Requirement	saverequirement_group3_27.json	${asset_Id_Product1}
...
25. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group3/Test_Case_27/case27c/inputrequest/request1.json	${asset_Id_Product1}
	run keyword if	${response1.status_code} != 200	Fail	test1 Teardown
	${response2}	Render Verdict	group3/Test_Case_27/case27c/inputrequest/request2.json	${asset_Id_Product1}
...
26. Complete Evaluation
	...
	run keyword if	'${result}' != '27 : PASS'	Fail	test1 Teardown
