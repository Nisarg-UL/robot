...
3. Asset Creation With POST Request
    ...
    create product3_siscase3 asset 	CreationOfRegressionProduct3_siscase2.json
...
25. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group3/Test_Case_17/case17b/inputrequest/request1.json	${asset_Id_Product1}
...
26. Complete Evaluation
	...
	run keyword if	'${result}' != '17 : NA'	Fail	test1 Teardown
