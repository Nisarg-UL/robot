...
23. Requirement Assignment To Product
	...
	Save Requirement	saverequirement_group3_17.json	${asset_Id_Product1}
...
25. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group3/Test_Case_17/case17a/inputrequest/request1.json	${asset_Id_Product1}
	run keyword if	${response1.status_code} != 200	Fail	test1 Teardown
	${response2}	Render Verdict	group3/Test_Case_17/case17a/inputrequest/request2.json	${asset_Id_Product1}
...
26. Complete Evaluation
	...
	run keyword if	'${result}' != '17 : PASS'	Fail	test1 Teardown
	${result1}   Clause Text     ${asset_Id_Product1}
	run keyword if	'${result1}' != '17'	fatal error
