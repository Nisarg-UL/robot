...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group2/Test_Case_13/case13a/inputrequest/request1.json	${asset_Id_Product1}
	run keyword if	${response1.status_code} != 200	Fail	test1 Teardown
	${response2}	Render Verdict	group2/Test_Case_13/case13a/inputrequest/request2.json	${asset_Id_Product1}
...
10. Complete Evaluation
	...
	run keyword if	${result} != ['13 : NA', '14-Q1 : NA', '14-Q2 : NA', '14-Q3 : NA', '14-Q4 : NA']	Fail	test1 Teardown
