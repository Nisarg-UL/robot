...
@{database}  pymysql    infopltfrm_transDBv05   ul_transUser    helloworld  10.40.76.82    3306	#DB for TRN
...
${response_api}
${response_search_api}
${certificate_hierarchy_Id}      92bcd3fc-1ed3-4ecf-80c6-64834ad997f0
${certificate2_hierarchy_Id}     104aa844-d5f7-4285-85a1-71db1c413d13
#${certificate3_hierarchy_Id}
${certificate_metadataId}        fd8e7ad1-b063-451b-8229-afe3fa7ad552
${certificate2_metadataId}       9238153c-c8e0-4b94-88e4-30756a7f9a3e
#${certificate3_metadataId}
${standard_hierarchy_Id}          dc90115f-7845-4429-b313-31eec9902357
${Reg_prod1_metadataId}           c5feb7e2-ff39-438d-aa32-0fa4a52f2da7
${Reg_prod2_metadataId}           40ea3e1e-3f5e-41e1-a507-08fa09d0aa88
${Reg_prod3_metadataId}           65413277-e985-46be-852c-2d4f2d5ec46d
${noEvalReqd_hierarchy_Id}     ge28b891-a43e-4f59-9f15-2554f93359fe
${regression_product_1_hierarchy_id}    ef023c64-f62c-4ba9-b358-af3752ee3a1f
${regression_product_2_hierarchy_id}    e59dce48-ab86-4b11-b092-d2cf6cbacd58
${regression_product_3_hierarchy_id}    ccb6fc3b-55c8-4b2b-b9bd-185b9e1ee73f
