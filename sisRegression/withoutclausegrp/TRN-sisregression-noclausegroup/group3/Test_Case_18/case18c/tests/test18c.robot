...
25. Render Verdict
	[Tags]	Functional	POST	Notcurrent
	${response1}	Render Verdict	group3/Test_Case_18/case18c/inputrequest/request1.json	${asset_Id_Product1}
	run keyword if	${response1.status_code} != 200	Fail	test1 Teardown
	${response2}	Render Verdict	group3/Test_Case_18/case18c/inputrequest/request2.json	${asset_Id_Product1}
...
26. Complete Evaluation
	...
	run keyword if	'${result}' != 'PASS'	Fail	test1 Teardown
