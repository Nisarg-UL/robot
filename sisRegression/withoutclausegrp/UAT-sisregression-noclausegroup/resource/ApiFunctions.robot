...
*** Variables ***
${API_ENDPOINT}	http://10.40.76.68:8080/InformationPlatformServices/api/v${Api_ver}	#For UAT

@{database}  pymysql    infopltfrm_transDBv05   ul_transUser    helloworld  10.40.76.66    3306	#DB for UAT
...
${response_api}
${response_search_api}
${certificate_hierarchy_Id}      86e024d8-8d3b-4179-a42b-5e723eeb44d7
${certificate2_hierarchy_Id}     d4b45869-c384-4959-9d5a-2b48219f00d0
#${certificate3_hierarchy_Id}
${certificate_metadataId}        d644caba-8675-42f9-84ad-c41b10fdb6e7
${certificate2_metadataId}       999c3273-3cbe-4bb8-9021-cec1c926e51d
#${certificate3_metadataId}
${standard_hierarchy_Id}          b6be9207-cd54-4ed5-9fee-7e3b4e5a1f30
${Reg_prod1_metadataId}           7b93a244-46e2-4bac-901e-d03875fe934d
${Reg_prod2_metadataId}           6a27d4bc-80c5-4c16-beda-ba38da2cfc35
${Reg_prod3_metadataId}           da456da5-daad-4eaa-be9e-b5090f1cae48
${noEvalReqd_hierarchy_Id}     ge28b891-a43e-4f59-9f15-2554f93359fe
${regression_product_1_hierarchy_id}    42a5c627-a209-483c-9ebf-0b892a1ed039
${regression_product_2_hierarchy_id}    9c87fdd5-2263-4892-a07d-938b8458d544
${regression_product_3_hierarchy_id}    4b61e8df-dbfc-4772-9db5-9790497d026f
