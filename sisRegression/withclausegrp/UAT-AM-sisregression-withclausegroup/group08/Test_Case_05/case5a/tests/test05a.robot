...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict  group08/Test_Case_05/case5a/inputrequest/request1.json	${asset_Id_Product1}
	...
	log to console  ${result}
	${response2}	Render Verdict	group08/Test_Case_05/case5a/inputrequest/request2.json	${asset_Id_Product1}
...
10. Complete Evaluation
	...
	run keyword if	'${result}' != '2 : PASS : Clause Group = b'	Fail	test1 Teardown
