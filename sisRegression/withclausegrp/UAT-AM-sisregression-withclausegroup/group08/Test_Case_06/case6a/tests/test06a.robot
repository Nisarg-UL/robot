...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict  group08/Test_Case_06/case6a/inputrequest/request1.json	${asset_Id_Product1}
...
#	run keyword if	'${result}' != 'GN on RP2 - row 9.'	Fail	test1 Teardown
#	log to console  ${result}
	${response2}	Render Verdict	group08/Test_Case_06/case6a/inputrequest/request2.json	${asset_Id_Product1}
...
10. Complete Evaluation
	...
	run keyword if	'${result}' != '2 : FAIL : Clause Group = b'	Fail	test1 Teardown
