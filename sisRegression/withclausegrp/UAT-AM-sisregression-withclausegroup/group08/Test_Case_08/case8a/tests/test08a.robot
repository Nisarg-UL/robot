...
7. Requirement Assignment To Product
	[Tags]	Functional	POST	current
	Save Requirement	saverequirement_group8_02.json	${asset_Id_Product1}
...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict  group08/Test_Case_08/case8a/inputrequest/request1.json	${asset_Id_Product1}
...
#	${result}  Get Guidance Notes RP1_2   ${response_api}
#	run keyword if	'${result}' != 'GN on RP2 - row 6.'	Fail	test1 Teardown
#	log to console  ${result}
	${response2}	Render Verdict	group08/Test_Case_08/case8a/inputrequest/request2.json	${asset_Id_Product1}
...
#	run keyword if	'${result}' != '2.1 : PASS : Clause Group = b'	Fail	test1 Teardown
