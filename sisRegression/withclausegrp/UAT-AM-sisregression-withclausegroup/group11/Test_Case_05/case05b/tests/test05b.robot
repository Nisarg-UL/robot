...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group11/Test_Case_05/case05b/inputrequest/request1.json	${asset_Id_Product1}
...
10. Complete Evaluation
	...
	run keyword if	'${result}' != '4 : NA : Clause Group = 4'	Fail	test1 Teardown
