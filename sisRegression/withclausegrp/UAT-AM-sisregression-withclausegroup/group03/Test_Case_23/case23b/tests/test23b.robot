...
22. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group03/Test_Case_23/case23b/inputrequest/request1.json	${asset_Id_Product1}
...
23. Complete Evaluation
	...
	run keyword if	'${result}' != '23 : NA : Clause Group = h'	Fail	test1 Teardown
