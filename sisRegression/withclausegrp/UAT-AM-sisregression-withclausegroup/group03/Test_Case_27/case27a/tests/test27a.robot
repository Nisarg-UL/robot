...
25. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group03/Test_Case_27/case27a/inputrequest/request1.json	${asset_Id_Product1}
...
27. Complete Evaluation
	...
	run keyword if	'${result}' != '27 : NA : Clause Group = j'	Fail	test1 Teardown
