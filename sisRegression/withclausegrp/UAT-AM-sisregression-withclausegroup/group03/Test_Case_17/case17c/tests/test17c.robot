...
25. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group03/Test_Case_17/case17c/inputrequest/request1.json	${asset_Id_Product1}
...
26. Complete Evaluation
	...
	run keyword if	'${result}' != '17 : NA : Clause Group = b'	Fail	test1 Teardown
