...
25. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group03/Test_Case_24/case24c/inputrequest/request1.json	${asset_Id_Product1}
...
26. Complete Evaluation
	...
	run keyword if	'${result}' != '24 : NA : Clause Group = i'	Fail	test1 Teardown
