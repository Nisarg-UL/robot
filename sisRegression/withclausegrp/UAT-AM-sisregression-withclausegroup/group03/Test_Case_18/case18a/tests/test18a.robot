...
25. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group03/Test_Case_18/case18a/inputrequest/request1.json	${asset_Id_Product1}
...
26. Complete Evaluation
	...
	run keyword if	'${result}' != '18 : NA : Clause Group = c'	Fail	test1 Teardown
