...
9. Render Verdict
	[Tags]	Functional	POST	Notcurrent
	${response1}	Render Verdict	group17/Test_Case_09/case9a/inputrequest/request1.json	${asset_Id_Product1}
	run keyword if	${response1.status_code} != 200	Fail	test1 Teardown
	${response2}	Render Verdict	group17/Test_Case_09/case9a/inputrequest/request2.json	${asset_Id_Product1}
