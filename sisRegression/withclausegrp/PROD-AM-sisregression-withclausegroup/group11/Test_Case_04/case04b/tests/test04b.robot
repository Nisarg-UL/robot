...
1. Asset Creation With POST Request
    ...
    create product1_siscase2 asset	CreationOfRegressionProduct1_siscase3.json
...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group11/Test_Case_04/case04b/inputrequest/request1.json	${asset_Id_Product1}
...
10. Complete Evaluation
	...
	run keyword if	'${result}' != '3 : NA : Clause Group = 3'	Fail	test1 Teardown
