...
def reviewer_summary_details(blob):
	...
	return json.dumps(clause_id_data), json.dumps(group_data), json.dumps(override_ver_data), json.dumps(subgroup_data), json.dumps(context_data), json.dumps(ver_data), json.dumps(assessment_id_data), json.dumps(remark_data), json.dumps(assessment_param_id_data)
...
def reviewer_summary_details_for_multiple_sub_grp(blob):
	...
	group2_data = data_dict["data"]["items"][1]["requirementGroup"]
	override_ver2_data = data_dict["data"]["items"][1]["overriddenVerdict"]
	subgroup2_data = data_dict["data"]["items"][1]["requirementSubGroup"]
	...
	return json.dumps(clause_id_data), json.dumps(group_data), json.dumps(override_ver_data), json.dumps(subgroup_data), json.dumps(context_data), json.dumps(ver_data), json.dumps(assessment_id_data), json.dumps(remark_data), json.dumps(assessment_param_id_data), json.dumps(clause_id2_data), json.dumps(group2_data), json.dumps(override_ver2_data), json.dumps(subgroup2_data), json.dumps(context2_data), json.dumps(ver2_data), json.dumps(assessment_id2_data), json.dumps(remark2_data), json.dumps(assessment_param_id2_data)