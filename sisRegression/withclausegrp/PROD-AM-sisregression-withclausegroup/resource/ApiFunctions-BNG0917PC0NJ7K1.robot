...
*** Variables ***
${API_ENDPOINT}	http://10.40.76.45:8080/InformationPlatformServices/api/v${Api_ver}	#For DEV
...
${standard_hierarchy_Id}         1080ea4c-cd1f-4033-b748-249fc8980ab7         #for PROD - with clause group
#${standard_hierarchy_Id}          a9a9d47a-6a61-4026-9d58-92952ddf38b9         #for PROD - no clause group
${Reg_prod1_metadataId}           0b80e186-7828-4a9b-bd8b-0c8b18361d79         #for PROD
...
${regression_product_1_hierarchy_id}    a2504f2f-6915-469f-916b-88240f367319   #for PROD
