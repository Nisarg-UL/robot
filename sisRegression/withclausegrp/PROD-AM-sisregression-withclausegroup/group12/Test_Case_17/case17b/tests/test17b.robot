...
8. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group12/Test_Case_17/case17b/inputrequest/request1.json	${asset_Id_Product1}
...
9. Complete Evaluation
	...
	run keyword if	'${result}' != '17 : NA : Clause Group = 17'	Fail	test1 Teardown
