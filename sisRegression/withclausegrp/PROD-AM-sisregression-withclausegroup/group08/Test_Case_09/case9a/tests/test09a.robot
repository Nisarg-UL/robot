...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict  group08/Test_Case_09/case9a/inputrequest/request1.json	${asset_Id_Product1}
...
#	log to console  ${result}
	...
	log to console  ${result}
	${response2}	Render Verdict	group08/Test_Case_09/case9a/inputrequest/request2.json	${asset_Id_Product1}
