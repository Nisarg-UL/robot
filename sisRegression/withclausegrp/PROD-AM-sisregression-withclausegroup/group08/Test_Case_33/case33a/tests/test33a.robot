...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict  group08/Test_Case_33/case33a/inputrequest/request1.json	${asset_Id_Product1}
	...
	${response2}	Render Verdict	group08/Test_Case_33/case33a/inputrequest/request2.json	${asset_Id_Product1}
