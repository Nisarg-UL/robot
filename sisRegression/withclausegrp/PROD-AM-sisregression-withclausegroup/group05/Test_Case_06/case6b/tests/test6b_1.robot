...
10. Context2 Assignment To Product
	[Tags]	Functional	POST	current
	Save Requirement	saverequirement_group1_08_withproduct1context2.json	${asset_Id_Product1}
...
16. Get Context
    ...
    run keyword if  '${Context_desc1}' != 'Automation_Product1_context2'   Fail	test1 Teardown
