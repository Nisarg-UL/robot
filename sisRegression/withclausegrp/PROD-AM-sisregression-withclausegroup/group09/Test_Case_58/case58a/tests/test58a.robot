...
7. Requirement Assignment To Product
	[Tags]	Functional	POST	current
	Save Requirement	Saverequirement_group9/saverequirement_group9_058.json	${asset_Id_Product1}
...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict  group09/Test_Case_58/case58a/inputrequest/request1.json	${asset_Id_Product1}
	...
	${response2}	Render Verdict	group09/Test_Case_58/case58a/inputrequest/request2.json	${asset_Id_Product1}
...
10. Complete Evaluation
	...
	run keyword if	'${result}' != '58 : PASS : Clause Group = a58'	Fail	test1 Teardown
