...
9. Render Verdict
	[Tags]	Functional	POST	Notcurrent
	${response1}	Render Verdict	group11/Test_Case_02/case02b/inputrequest/request1.json	${asset_Id_Product1}
...
10. Complete Evaluation
	...
	run keyword if	'${result}' != '1 : NA : Clause Group = 1'	Fail	test1 Teardown
