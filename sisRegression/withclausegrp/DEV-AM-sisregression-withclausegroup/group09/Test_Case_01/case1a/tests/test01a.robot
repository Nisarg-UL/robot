...
7. Requirement Assignment To Product
	[Tags]	Functional	POST	current
	Save Requirement	Saverequirement_group9/saverequirement_group9_001.json	${asset_Id_Product1}
...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict  group09/Test_Case_01/case1a/inputrequest/request1.json	${asset_Id_Product1}
	...
	${response2}	Render Verdict	group09/Test_Case_01/case1a/inputrequest/request2.json	${asset_Id_Product1}
...
#	run keyword if	'${result}' != '1 : PASS : Clause Group = a1'	Fail	test1 Teardown
