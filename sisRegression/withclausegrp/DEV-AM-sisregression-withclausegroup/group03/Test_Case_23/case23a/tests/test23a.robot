...
22. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group03/Test_Case_23/case23a/inputrequest/request1.json	${asset_Id_Product1}
	run keyword if	${response1.status_code} != 200	Fail	test1 Teardown
	${response2}	Render Verdict	group03/Test_Case_23/case23a/inputrequest/request2.json	${asset_Id_Product1}
...
23. Complete Evaluation
	...
	run keyword if	'${result}' != '23 : PASS : Clause Group = h'	Fail	test1 Teardown
