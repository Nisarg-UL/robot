...
25. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group03/Test_Case_20/case20c/inputrequest/request1.json	${asset_Id_Product1}
...
26. Complete Evaluation
	...
	run keyword if	'${result}' != '20 : NA : Clause Group = e'	Fail	test1 Teardown
