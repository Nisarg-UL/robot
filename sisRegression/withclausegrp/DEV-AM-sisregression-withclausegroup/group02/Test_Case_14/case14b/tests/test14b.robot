...
6. Requirement Assignment To Product
	[Tags]	Functional	POST	current
	Save Requirement	saverequirement_group2_14.json	${asset_Id_Product1}
...
8. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group02/Test_Case_14/case14b/inputrequest/request1.json	${asset_Id_Product1}
	run keyword if	${response1.status_code} != 200	Fail	test1 Teardown
	${response2}	Render Verdict	group02/Test_Case_14/case14b/inputrequest/request2.json	${asset_Id_Product1}
...
10. Get Reviewer Summary Details
	...
	should be equal  	"${summary}"    "[['1.1', 'Test Case 14 - Evaluation Not Required on Sub-Group - Multiple Clause Questions per Sub-Group', 'Group 2 - Evaluation Not Required Tests'], ['1.2', 'Test Case 14 - Evaluation Not Required on Sub-Group - Multiple Clause Questions per Sub-Group', 'Group 2 - Evaluation Not Required Tests'], ['1.3', 'Test Case 14 - Evaluation Not Required on Sub-Group - Multiple Clause Questions per Sub-Group', 'Group 2 - Evaluation Not Required Tests'], ['1.4', 'Test Case 14 - Evaluation Not Required on Sub-Group - Multiple Clause Questions per Sub-Group', 'Group 2 - Evaluation Not Required Tests']]"