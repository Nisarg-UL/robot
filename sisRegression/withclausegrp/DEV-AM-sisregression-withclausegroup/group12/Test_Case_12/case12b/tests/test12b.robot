...
8. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group12/Test_Case_12/case12b/inputrequest/request1.json	${asset_Id_Product1}
...
9. Complete Evaluation
	...
	run keyword if	'${result}' != '12 : NA : Clause Group = 12'	Fail	test1 Teardown
