...
8. Render Verdict
	[Tags]	Functional	POST	Notcurrent
	${response1}	Render Verdict	group12/Test_Case_21/case21b/inputrequest/request1.json	${asset_Id_Product1}
...
9. Complete Evaluation
	...
	run keyword if	'${result}' != '21 : NA : Clause Group = 21'	Fail	test1 Teardown
