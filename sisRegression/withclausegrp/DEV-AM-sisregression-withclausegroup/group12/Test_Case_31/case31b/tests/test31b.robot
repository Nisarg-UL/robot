...
8. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group12/Test_Case_31/case31b/inputrequest/request1.json	${asset_Id_Product1}
...
9. Complete Evaluation
	...
	run keyword if	'${result}' != '31 : NA : Clause Group = 31'	Fail	test1 Teardown
