...
7. Requirement Assignment To Product
	[Tags]	Functional	POST	current
	Save Requirement	saverequirement_group1_09.json	${asset_Id_Product1}
...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group01/Test_Case_09/case9a/inputrequest/request1.json	${asset_Id_Product1}
...
10. Complete Evaluation
	...
	${result1}	Notes	${asset_Id_Product1}
	log to console	'Result of Note = ${result1}