...
7. Requirement Assignment To Product
	[Tags]	Functional	POST	Notcurrent
	Save Requirement	Saverequirement_group9/saverequirement_group9_028.json	${asset_Id_Product1}
...
9. Render Verdict
	[Tags]	Functional	POST	Notcurrent
	${response1}	Render Verdict  group09/Test_Case_28/case28a/inputrequest/request1.json	${asset_Id_Product1}
	...
	${response2}	Render Verdict	group09/Test_Case_28/case28a/inputrequest/request2.json	${asset_Id_Product1}
...
10. Complete Evaluation
	...
	run keyword if	'${result}' != '28 : PASS : Clause Group = a28'	Fail	test1 Teardown
