...
9. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict  group04/Test_Case_40/case40j-edit1.1c,1.2b,1.3a/inputrequest/request1.json	${asset_Id_Product1}
	run keyword if	${response1.status_code} != 200	Fail	test1 Teardown
	${response2}	Render Verdict	group04/Test_Case_40/case40j-edit1.1c,1.2b,1.3a/inputrequest/request2.json	${asset_Id_Product1}
	run keyword if	${response2.status_code} != 200	Fail	test1 Teardown
	${response3}	Render Verdict	group04/Test_Case_40/case40j-edit1.1c,1.2b,1.3a/inputrequest/request3.json	${asset_Id_Product1}
	...
	run keyword if	${result} != ['1.1c, 1.2b, 1.3a : PASS : Clause Group = e,f,g', '1.4b : PASS : Clause Group = h']   Fail	test1 Teardown
	${response4}	Render Verdict  group04/Test_Case_40/case40j-edit1.1c,1.2b,1.3a/inputrequest/request4.json	${asset_Id_Product1}
	run keyword if	${response4.status_code} != 200	Fail	test1 Teardown
	${response5}	Render Verdict	group04/Test_Case_40/case40j-edit1.1c,1.2b,1.3a/inputrequest/request5.json	${asset_Id_Product1}
	run keyword if	${response5.status_code} != 200	Fail	test1 Teardown
	${response6}	Render Verdict	group04/Test_Case_40/case40j-edit1.1c,1.2b,1.3a/inputrequest/request6.json	${asset_Id_Product1}
