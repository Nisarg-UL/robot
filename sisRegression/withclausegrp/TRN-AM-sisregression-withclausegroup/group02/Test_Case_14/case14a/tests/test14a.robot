...
8. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group02/Test_Case_14/case14a/inputrequest/request1.json	${asset_Id_Product1}
	run keyword if	${response1.status_code} != 200	Fail	test1 Teardown
	${response2}	Render Verdict	group02/Test_Case_14/case14a/inputrequest/request2.json	${asset_Id_Product1}
...
#	run keyword if	${result} != ['14-Q1 : NA : Clause Group = b', '14-Q2 : NA : Clause Group = c']	Fail	test1 Teardown
	run keyword if	${result} != ['14-Q1 : NA : Clause Group = ', '14-Q2 : NA : Clause Group = ']	Fail	test1 Teardown
...
10. Get Reviewer Summary Details
	...
	should be equal  	"${summary}"    "[['14-Q1', 'Test Case 14 - Evaluation Not Required on Sub-Group - Multiple Clause Questions per Sub-Group', 'Group 2 - Evaluation Not Required Tests'], ['14-Q2', 'Test Case 14 - Evaluation Not Required on Sub-Group - Multiple Clause Questions per Sub-Group', 'Group 2 - Evaluation Not Required Tests']]"