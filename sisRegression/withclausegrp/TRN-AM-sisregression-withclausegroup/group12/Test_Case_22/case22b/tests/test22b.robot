...
8. Render Verdict
	[Tags]	Functional	POST	current
	${response1}	Render Verdict	group12/Test_Case_22/case22b/inputrequest/request1.json	${asset_Id_Product1}
...
9. Complete Evaluation
	...
	run keyword if	'${result}' != '22 : NA : Clause Group = 22'	Fail	test1 Teardown
